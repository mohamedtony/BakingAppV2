...
/**
 * Created by medo on 01-Nov-17.
 */

public class MyGridViewWidgetService extends RemoteViewsService {
    ...
    class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        public void onDataSetChanged() {
            remoteViewingredientsList = MyBakingWidgetProvider.ingredientsList;
        }
